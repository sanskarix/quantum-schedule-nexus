...
const EventTypesList: React.FC<EventTypesListProps> = ({
  ...
  return (
    <div className="space-y-4" onClick={handleContainerClick}>
      ...
      <div className={`rounded-xl p-4 border transition-all duration-200 hover:shadow-md hover:scale-[1.01] ${isDarkMode ? 'bg-[#212124] border-[#818181]/20' : 'bg-white border-gray-200'}`}>
        <div className="flex items-center justify-between">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center space-x-2">
                <div className={`link-container flex items-center space-x-2 transition-all duration-200 hover:scale-105`}>
                  <span className={`text-xs font-mono transition-colors duration-300 ${isDarkMode ? 'text-[#818181]' : 'text-gray-600'}`} style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}>
                    cal.id/sanskar
                  </span>
                  <button 
          ...
          <div className="flex space-x-6">
            {stats.map((stat, index) => (
              <div key={index} className="text-center space-y-1 transform transition-all duration-200 hover:scale-105">
        ...
        <div className="grid grid-cols-2 gap-3">
          {teams.slice(0, 4).map((team) => (
            <div
              ...
              className={`team-card p-3 border-2 cursor-pointer transition-all duration-200 rounded-lg hover:shadow-md ${
                selectedTeam?.id === team.id 
                  ? `border-[#C9D9E3]/40 bg-[#C9D9E3]/5 transform scale-[1.02] shadow-lg ${isDarkMode ? 'bg-[#C9D9E3]/10' : ''}`
                  : `${isDarkMode ? 'border-[#818181]/20 hover:border-[#818181]/40 bg-[#212124] hover:bg-[#212124]/80' : 'border-gray-200 hover:border-gray-300 bg-white hover:bg-gray-50'} hover:scale-[1.01]`
              }`}
            >
              <div className="flex items-center justify-between">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <div className="flex items-center space-x-1">
                      <div className={`link-container flex items-center space-x-2 text-xs transition-all duration-200 hover:scale-105`}>
                        <span className="font-mono" style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}>{team.slug}</span>
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
      ...
      <div className="flex items-center justify-between space-x-3">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-2 rounded-lg border transition-all duration-200 focus:ring-2 focus:ring-[#C9D9E3]/20 focus:border-[#C9D9E3] ${isDarkMode ? 'bg-[#212124] border-[#818181]/20 text-white placeholder-[#818181]' : 'bg-white border-gray-200 text-gray-900 placeholder-gray-400'} focus:outline-none text-sm`}
        ...
        <DropdownMenu open={showTeamSelector} onOpenChange={setShowTeamSelector}>
          <DropdownMenuTrigger asChild>
            <Button className="bg-[#C9D9E3] hover:bg-[#A8B8C8] text-white transition-all duration-200 hover:shadow-md" style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}>
          ...
          <DropdownMenuContent align="end" className={`w-48 transition-all duration-100 shadow-lg ${isDarkMode ? 'bg-[#212124]/95 backdrop-blur-md border-[#818181]/20' : 'bg-white/95 backdrop-blur-md border-gray-200'}`}>
            <DropdownMenuItem 
              ...
              className={`transition-colors duration-200 ${isDarkMode ? 'text-white hover:bg-[#818181]/10' : 'text-gray-900 hover:bg-gray-50'}`}
              style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}
            >
              Personal (Sanskar)
            </DropdownMenuItem>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="sm" className="flex items-center space-x-1">
                    <span className={`text-sm ${isDarkMode ? 'text-[#818181]' : 'text-gray-600'}`} style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}>
                      {getTeamCreateText()}
                    </span>
                ...
                <DropdownMenuContent align="end" className={`w-48 transition-all duration-100 shadow-lg ${isDarkMode ? 'bg-[#212124]/95 backdrop-blur-md border-[#818181]/20' : 'bg-white/95 backdrop-blur-md border-gray-200'}`}>
                  <DropdownMenuItem 
                    onClick={() => setSelectedCreateTeam(null)}
                    className={`transition-colors duration-200 ${isDarkMode ? 'text-white hover:bg-[#818181]/10' : 'text-gray-900 hover:bg-gray-50'}`}
                    style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}
                  >
                    Personal (Sanskar)
                  ...
                  {teams.map((team) => (
                    <DropdownMenuItem 
                      key={team.id}
                      onClick={() => setSelectedCreateTeam(team)}
                      className={`transition-colors duration-200 ${isDarkMode ? 'text-white hover:bg-[#818181]/10' : 'text-gray-900 hover:bg-gray-50'}`}
                      style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}
                    >
                      <span className="mr-2">{team.logo}</span>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 rounded-lg border transition-all duration-200 focus:ring-2 focus:ring-[#C9D9E3]/20 focus:border-[#C9D9E3] ${isDarkMode ? 'bg-[#212124] border-[#818181]/20 text-white' : 'bg-white border-gray-200 text-gray-900'} focus:outline-none text-sm`}
            ...
            <div>
              ...
              <div className="flex items-center">
                <span className={`px-3 py-2 rounded-l-lg border-r-0 border transition-colors duration-300 ${isDarkMode ? 'bg-[#212124] border-[#818181]/20 text-[#818181]' : 'bg-gray-50 border-gray-200 text-gray-500'} text-sm`} style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}>
                  {getUrlPrefix()}/
                </span>
                <input
                  type="text"
                  ...
                  className={`flex-1 px-3 py-2 rounded-r-lg border transition-all duration-200 focus:ring-2 focus:ring-[#C9D9E3]/20 focus:border-[#C9D9E3] ${isDarkMode ? 'bg-[#212124] border-[#818181]/20 text-white' : 'bg-white border-gray-200 text-gray-900'} focus:outline-none text-sm`}
                  style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 rounded-lg border transition-all duration-200 focus:ring-2 focus:ring-[#C9D9E3]/20 focus:border-[#C9D9E3] ${isDarkMode ? 'bg-[#212124] border-[#818181]/20 text-white placeholder-[#818181]' : 'bg-white border-gray-200 text-gray-900 placeholder-gray-400'} focus:outline-none text-sm`}
            ...
            <div className="flex justify-end space-x-3 pt-4">
              <Button 
                ...
                className={`transition-colors duration-200 ${isDarkMode ? 'border-[#818181]/20 text-[#818181] hover:bg-[#818181]/10' : 'border-gray-200 text-gray-600 hover:bg-gray-50'}`}
                style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}
              >
                Cancel
              </Button>
              <Button 
                ...
                className="bg-[#C9D9E3] hover:bg-[#A8B8C8] text-white transition-all duration-200"
        ...
        {filteredEventTypes.map((event: any, index: number) => {
          ...
          return (
            <div
              ...
              className={`group rounded-lg p-3 border cursor-pointer transition-all duration-200 hover:shadow-md hover:scale-[1.01] ${
                dragOverItem === index 
                  ? `${isDarkMode ? 'border-[#C9D9E3]/50 bg-[#C9D9E3]/10' : 'border-[#C9D9E3]/30 bg-[#C9D9E3]/5'}` 
                ...
                <div className="flex items-center space-x-3 flex-1">
                  <div className="flex flex-col space-y-1 opacity-0 group-hover:opacity-100 transition-all duration-200">
                    <button
                      ...
                      disabled={index === 0}
                      className={`p-1 rounded transition-all duration-200 ${index === 0 ? 'opacity-30 cursor-not-allowed' : 'hover:bg-gray-100'}`}
                    >
                    ...
                    <button
                      ...
                      className={`p-1 rounded transition-all duration-200 ${index === filteredEventTypes.length - 1 ? 'opacity-30 cursor-not-allowed' : 'hover:bg-gray-100'}`}
                    >
                  ...
                  <div className="flex-1 space-y-1">
                    <div className="flex items-center space-x-2 mb-1">
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded-full transition-all duration-200 ${isDarkMode ? 'bg-[#818181]/20 text-[#818181]' : 'bg-gray-100 text-gray-600'}`} style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}>
                    ...
                    <div className="flex items-center space-x-1">
                      {event.durations.map((duration: string) => (
                        <span
                          key={duration}
                          className={`px-2 py-0.5 rounded-full text-xs transition-all duration-200 ${isDarkMode ? 'bg-[#818181]/20 text-[#818181]' : 'bg-gray-100 text-gray-600'}`}
                          style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}
                        >
                          {duration}
                        </span>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-all duration-200">
                    ...
                    <Button 
                      variant="ghost" 
                      size="icon" 
                      className="w-8 h-8 transition-all duration-200 relative group"
                      onClick={(e) => { 
                        e.stopPropagation(); 
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className={`transition-all duration-100 shadow-lg ${isDarkMode ? 'bg-[#212124]/95 backdrop-blur-md border-[#818181]/20' : 'bg-white/95 backdrop-blur-md border-gray-200'}`}>
                        ...
                        <DropdownMenuItem 
                          ...
                          className={`text-red-600 transition-colors duration-200 ${isDarkMode ? 'hover:bg-[#818181]/10' : 'hover:bg-gray-50'}`}
                          style={{ fontFamily: 'SF Pro Display, -apple-system, BlinkMacSystemFont, system-ui, sans-serif' }}
                        >
