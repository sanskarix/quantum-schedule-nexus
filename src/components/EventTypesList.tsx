...
const EventTypesList: React.FC<EventTypesListProps> = ({
  ...
  return (
    <div className="space-y-4" onClick={handleContainerClick}>
      ...
      <div className={`rounded-xl p-4 border transition-all duration-200 hover:shadow-md ${isDarkMode ? 'bg-[#212124] border-[#818181]/20' : 'bg-white border-gray-200'}`}>
              ...
              <div className="flex items-center space-x-2">
                <div className={`link-container flex items-center space-x-2 transition-all duration-200 hover:scale-105`}>
                  ...
                  >
                    ...
                    {copiedItems.profile && (
                      <span className={`absolute -top-6 left-1/2 transform -translate-x-1/2 px-2 py-1 text-xs rounded shadow-lg animate-fade-in ${isDarkMode ? 'bg-[#212124] text-white' : 'bg-gray-900 text-white'}`}>
                        Copied!
                      </span>
                    )}
                  </button>
          ...
          <div className="flex space-x-6">
            {stats.map((stat, index) => (
              <div key={index} className="text-center space-y-1 transform transition-all duration-200 hover:scale-105">
                ...
                <p className={`text-xs font-medium transition-colors duration-300 ${isDarkMode ? 'text-[#818181]' : 'text-gray-600'}`}>
                  {stat.label}
                </p>
        ...
        <div className="grid grid-cols-2 gap-3">
          {teams.slice(0, 4).map((team) => (
            <div
              ...
              className={`team-card p-4 border-2 cursor-pointer transition-all duration-300 rounded-lg ${
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className={`w-10 h-10 rounded-lg ${team.color === 'azure' ? 'bg-azure' : team.color === 'pulse' ? 'bg-pulse' : team.color === 'amber' ? 'bg-amber' : 'bg-quantum'} flex items-center justify-center text-white text-sm shadow-md`}>
                    {team.logo}
                  </div>
                  <div className="flex-1 space-y-1">
                    ...
                    <div className="flex items-center space-x-1">
                      <span className={`text-xs font-mono transition-colors duration-300 ${isDarkMode ? 'text-[#818181]' : 'text-gray-500'}`}>
                        {team.slug}
                      </span>
                    </div>
                  </div>
      ...
      <div className="flex items-center space-x-3">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-2.5 rounded-lg border transition-all duration-300 focus:ring-2 focus:ring-azure/20 focus:border-azure ${isDarkMode ? 'bg-[#212124] border-[#818181]/20 text-white placeholder-[#818181]' : 'bg-white border-gray-200 text-gray-900 placeholder-gray-400'} focus:outline-none text-sm`}
          />
        </div>
        ...
        <DropdownMenu open={showTeamSelector} onOpenChange={setShowTeamSelector}>
          ...
          <DropdownMenuContent align="end" className={`w-48 transition-colors duration-300 shadow-lg ${isDarkMode ? 'bg-[#212124] border-[#818181]/20' : 'bg-white border-gray-200'}`}>
            <DropdownMenuItem 
              onClick={() => {
                setSelectedCreateTeam(null);
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent className={`transition-colors duration-300 ${isDarkMode ? 'bg-[#212124] border-[#818181]/20' : 'bg-white border-gray-200'}`}>
          <DialogHeader>
            <DialogTitle className={`text-lg font-semibold transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
          ...
          <div className="space-y-4">
            <div>
              <label className={`block text-sm font-medium mb-2 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                Title
              </label>
              <input
                type="text"
                ...
                className={`w-full px-3 py-2 rounded-lg border transition-all duration-300 focus:ring-2 focus:ring-azure/20 focus:border-azure ${isDarkMode ? 'bg-[#161618] border-[#818181]/20 text-white' : 'bg-white border-gray-200 text-gray-900'} focus:outline-none text-sm`}
            ...
            <div>
              ...
              <div className="flex items-center">
                <span className={`px-3 py-2 rounded-l-lg border-r-0 border transition-colors duration-300 ${isDarkMode ? 'bg-[#161618] border-[#818181]/20 text-[#818181]' : 'bg-gray-50 border-gray-200 text-gray-500'} text-sm`}>
                  cal.id/sanskar/
                </span>
                <input
                  type="text"
                  ...
                  className={`flex-1 px-3 py-2 rounded-r-lg border transition-all duration-300 focus:ring-2 focus:ring-azure/20 focus:border-azure ${isDarkMode ? 'bg-[#161618] border-[#818181]/20 text-white' : 'bg-white border-gray-200 text-gray-900'} focus:outline-none text-sm`}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 rounded-lg border transition-all duration-300 focus:ring-2 focus:ring-azure/20 focus:border-azure ${isDarkMode ? 'bg-[#161618] border-[#818181]/20 text-white placeholder-[#818181]' : 'bg-white border-gray-200 text-gray-900 placeholder-gray-400'} focus:outline-none text-sm`}
            ...
            <div className="flex justify-end space-x-3 pt-4">
              ...
              <Button 
                ...
                className="bg-azure hover:bg-azure/90 text-white transition-all duration-200"
      ...
      <div className="space-y-2">
        {filteredEventTypes.map((event: any) => (
          <div
            ...
            className={`group rounded-lg p-3 border cursor-pointer transition-all duration-200 hover:shadow-sm hover:scale-101 ${
              ...
              <div className="flex items-center space-x-3 flex-1">
                ...
                <div className="flex-1 space-y-1">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className={`text-xs px-2 py-0.5 rounded-full transition-all duration-200 ${isDarkMode ? 'bg-[#818181]/20 text-[#818181]' : 'bg-gray-100 text-gray-600'}`}>
                      {event.bookingsToday} today
                    </span>
                  </div>
                  <p className={`text-xs mb-1 transition-colors duration-300 ${isDarkMode ? 'text-[#818181]' : 'text-gray-600'}`}>
                    {event.description}
                  </p>
                  <div className="flex items-center space-x-1">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-all duration-200">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className={`transition-colors duration-300 shadow-lg ${isDarkMode ? 'bg-[#212124] border-[#818181]/20' : 'bg-white border-gray-200'}`}>
                      <DropdownMenuItem 
      ...
      {filteredEventTypes.length === 0 && (
        <div className="text-center py-12">
          <p className={`text-sm transition-colors duration-300 ${isDarkMode ? 'text-[#818181]' : 'text-gray-500'}`}>
